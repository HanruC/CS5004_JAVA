...
public class OvalTest {
  ...
  @Before
  public void setUp() {
    oval1 = new Oval("o1", 5.0, 10.0, 0.5, 0.7,
            0.9, 20.0, 30.0);
  }
  ...
  public void testOvalChangeThreeColor() {
    assertTrue(oval1.changeThreeColor(0.8, 0.6, 0.4));
    assertEquals(0.8, oval1.getRed(), 0.001);
    assertEquals(0.6, oval1.getGreen(), 0.001);
    assertEquals(0.4, oval1.getBlue(), 0.001);
  }
  ...
  public void testOvalChangeThreeColorInvalid() {
    assertFalse(oval1.changeThreeColor(1.2, -0.1, 1.5));
    assertEquals(5.0 , oval1.getRed(), 0.001);
    assertEquals(10.0, oval1.getGreen(), 0.001);
    assertEquals(0.5, oval1.getBlue(), 0.001);
  }
  ...
  public void testNegativeParameters() {
    Oval ovalInvalid = new Oval("o2", -5, -10, -0.5,
            -0.7, -0.9, -20, -30);
