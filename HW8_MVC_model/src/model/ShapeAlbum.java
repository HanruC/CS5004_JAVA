...
public class ShapeAlbum implements IAlbum {
   ...
   */
  @Override
  public boolean createShape(String type, String name, double x, double y, double red,
   ...
   */
  public boolean changeColorAndCheck(String name, double red, double green, double blue) {
    Shape shape = shapeStorage.getShapeObject(name);
    if (shape != null) {
