...
public class ShapeFactoryDesign {
   ...
   * @return the shape.
   */
  public Shape createShape(String type, String name, double x, double y, int red,
                           int green, int blue, double firstParameter,
                           double secondParameter) {
    if (type.equalsIgnoreCase("Oval")) {
      return new Oval(name, red, green, blue, x, y, firstParameter, secondParameter);
    } else if (type.equalsIgnoreCase("Rectangle")) {
      return new Rectangle(name, red, green, blue, x, y,firstParameter, secondParameter);
    } else {
      return null;
    }
  }
