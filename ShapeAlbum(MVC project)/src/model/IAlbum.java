...
public interface IAlbum {
   ...
   */
  boolean createShape(String type, String name, double x, double y, int red, int green,
                      int blue, double firstParameter, double secondParameter);
   ...
   */
  boolean changeColorAndCheck(String name, int red, int green, int blue);
