...
public class ShapeAlbumTest {
  ...
  public void testAddShape() {
    ...
    Shape oval = new Oval("oval1", 10, 20,
    ...
    Shape rectangle = new Rectangle("rectangle1", 30,
            40, 50, 100, 150, 70.0, 90.0);
  ...
  public void testGetSnapshot() {
    shapeAlbum.createShape("Oval", "o1", 5, 10, 5,
            7, 9, 20, 30);
    shapeAlbum.createSnapshot("first snapshot");
  ...
  public void testChangeColorAndCheck() {
    shapeAlbum.createShape("Oval", "o1", 5, 10, 5, 7,
            9, 20, 30);
    assertTrue(shapeAlbum.changeColorAndCheck("o1", 2, 8, 1));
    
    Shape shape = shapeAlbum.getShape("o1");
    assertNotNull(shape);
    assertEquals(2, shape.getRed(), 0.0001);
    assertEquals(8, shape.getGreen(), 0.0001);
    assertEquals(1, shape.getBlue(), 0.0001);
  }
  ...
  public void testToString() {
    ...
    shapeAlbum.createShape("Oval", "o1", 5, 10, 5,
            7, 9, 20, 30);
    shapeAlbum.createShape("Rectangle", "r1", 15, 20, 3,
            4, 5, 50, 70);
    shapeAlbum.createSnapshot("first snapshot");
